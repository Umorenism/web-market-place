...
//   // Data for active pools to enable mapping
//   const activePools = [
//     {
//       id: 1,
...
//               {/* Pool title */}
//               <div className="absolute top-[19px] left-[50px] font-m3-title-small font-[number:var(--m3-title-small-font-weight)] text-white text-[length:var(--m3-title-small-font-size)] tracking-[var(--m3-title-small-letter-spacing)] leading-[var(--m3-title-small-line-height)] whitespace-nowrap">
//                 {pool.title}
//               </div>
...
//                 <div className="font-m3-body-small font-[number:var(--m3-body-small-font-weight)] text-white text-[length:var(--m3-body-small-font-size)] tracking-[var(--m3-body-small-letter-spacing)] leading-[var(--m3-body-small-line-height)]">
//                   Reward
//                 </div>
...
//                 <div className="font-m3-body-small font-[number:var(--m3-body-small-font-weight)] text-white text-[length:var(--m3-body-small-font-size)] text-right tracking-[var(--m3-body-small-letter-spacing)] leading-[var(--m3-body-small-line-height)]">
//                   Participants
//                 </div>
